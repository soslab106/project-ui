...
class Practice extends Component {
    render() {
        return ( <
            ...
            placeholder = '密碼' / >
            <
            little className = 'text-sm-left'
            style = {
                { color: "red" } } > 需包含英文字母和數字 < /little> <
            /div>
            ...
            div className = 'form-group' > < input className = 'form-control'
            type = 'text'
            placeholder = '密碼確認' / > < /div>

            <
            div className = 'form-group mt-4' > < button className = 'form-control'
            type = 'submit' > 註冊 < /button></div >
            <
            /div> <
            /div>
        );
