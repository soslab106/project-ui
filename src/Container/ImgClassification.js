            ...
            <React.Fragment>
                <div className="container d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div className="row w-100 mt-5">
                        <ModelSelect className="d-flex p-3 mt-3 col-8">
                            <div className='d-flex justify-content-center align-items-center'><h2>VGG16</h2></div>
                            <div className='ml-4'>
                                <div>2014年分類亞軍(定位冠軍)VGGNet透過建立更多層的模型，達到了16及19個隱藏層。</div>
                                <a href="/VGG16"><button className="btn btn-model mt-4">前往VGG16介紹</button></a>
                    ...
                    <div className="row w-100 justify-content-end">
                        ...
                        <ModelSelect className="d-flex p-3 my-5 col-8">
                            <div className='mr-4'>
                                <div>2015年冠軍ResNets發現20層以上的模型會導致訓練出來的準確度越來越差，提出了殘差(Residual)來解決問題，是圖片辨識界的一大進步。</div>
                                <a href="/ResNet101"><button className="btn btn-model mt-4">前往ResNet101介紹</button></a>
                            </div>
